...
export default function FavoritesPage() {
  ...
  const [playerStats, setPlayerStats] = useState<PlayerSeasonStats | null>(
    null,
  );
            ...
            <>
                ...
                <div className="fav-team-info">
                  ...
                  {teamStats && (
                    <>
                      <div className="fav-stat-row">
                        ...
                        <div className="fav-stat-pill">
                          {avg(teamStats.totalPoints, teamStats.gamesPlayed)}{' '}
                          PPG
                        </div>
                        <div className="fav-stat-pill">
                          {avg(teamStats.totalRebounds, teamStats.gamesPlayed)}{' '}
                          RPG
                        </div>
                        <div className="fav-stat-pill">
                          {avg(teamStats.totalAssists, teamStats.gamesPlayed)}{' '}
                          APG
                        </div>
                      </div>
                    </>
                  ...
                  <div className="fav-next-games">
                    <span className="fav-next-label">
                      Upcoming games will appear once the schedule API is
                      connected.
                    </span>
                  </div>
                </div>
              ...
              {selectedPlayer ? (
                      ...
                      {playerStats && (
                        <div className="fav-player-stats-grid">
                          {[
                            ...
                            {
                              val: avg(
                                playerStats.totalBlocks,
                                playerStats.gamesPlayed,
                              ),
                              lbl: 'BPG',
                            },
                            {
                              val: String(playerStats.gamesPlayed ?? '—'),
                              lbl: 'GP',
                            },
                          ].map(({ val, lbl }) => (
                ...
                <div className="fav-roster-section">
                  ...
                  {loadingRoster && (
                    <p className="fav-loading">Loading roster…</p>
                  )}
